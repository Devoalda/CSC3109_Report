...
\begin{figure}[H] 
    ...
    \caption{(a) Traditional U-Net architecture \cite{Yakubovskiy_2019}}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{unet/unetpp.png}
    \caption{(b) U-Net++ architecture \cite{zhou_unet_2018}}
	\end{minipage}
	\caption{Comparison of Simple U-Net and U-Net++ architectures}\label{f:unet_vs_unetpp}
\end{figure}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1\textwidth]{unet/evaluation/kfolds.png}
  \end{center}
