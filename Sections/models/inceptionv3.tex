\subsection{InceptionV3}\label{inceptionv3}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=\textwidth]{inceptionv3/inceptionv3_arch.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.35\textwidth]{inceptionv3/evaluation/cm1.png}
    \includegraphics[width=0.35\textwidth]{inceptionv3/evaluation/cm2.png}
    \includegraphics[width=0.35\textwidth]{inceptionv3/evaluation/ROC.png}
    \includegraphics[width=0.35\textwidth]{inceptionv3/evaluation/learning_curve.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=1\textwidth]{inceptionv3/evaluation/kfolds.png}
  \end{center}
